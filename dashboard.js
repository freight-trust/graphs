...
var dataset = [];
var valueVsHonestyGraph = new liveGraph("#valueVsHonestyGraph", dataset, {plotType : "semilog", caption : "Total Staking Value vs. Pool Honesty"});
var trustVsHonestyGraph = new liveGraph("#trustVsHonestyGraph", dataset,  {caption : "Total Trust vs. Pool Honesty"});
var circularGraphs = [];
var nbBuckets = 4;
for (var i = 0; i < nbBuckets; ++i) {
    ...
    circularGraphs[i] = new circularGraph("#" + divName, {
        diameter: 250,
        caption : "Pool Honesty: " + 100*i/nbBuckets + "-" + 100*(i+1)/nbBuckets + "%"
    });
}
