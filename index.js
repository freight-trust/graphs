...
!(function () {
    ...
    function gn(n, t, e) {
        var r = (n + 16) / 116,
            u = r + t / 500,
            i = r - e / 200;
        return (u = vn(u) * Qa), (r = vn(r) * no), (i = vn(i) * to), new yn(mn(3.2404542 * u - 1.5371385 * r - 0.4985314 * i), mn(-0.969266 * u + 1.8760108 * r + 0.041556 * i), mn(0.0556434 * u - 0.2040259 * r + 1.0572252 * i));
    }
    function pn(n, t, e) {
    ...
    function _n(n, t, e) {
        ...
        return (i = uo.get(n))
            ...
            : (null == n ||
                  ...
                  (4 === n.length ? ((a = (3840 & i) >> 4), (a = (a >> 4) | a), (o = 240 & i), (o = (o >> 4) | o), (l = 15 & i), (l = (l << 4) | l)) : 7 === n.length && ((a = (16711680 & i) >> 16), (o = (65280 & i) >> 8), (l = 255 & i))),
              t(a, o, l));
    }
    function wn(n, t, e) {
        var r,
            ...
            o = a - i,
            l = (a + i) / 2;
        return o ? ((u = 0.5 > l ? o / (a + i) : o / (2 - a - i)), (r = n == a ? (t - e) / o + (e > t ? 6 : 0) : t == a ? (e - n) / o + 2 : (n - t) / o + 4), (r *= 60)) : ((r = NaN), (u = l > 0 && 1 > l ? 0 : r)), new ln(r, u, l);
    }
    function Sn(n, t, e) {
                ...
                (t.parse = function (t) {
                    ...
                    return (
                        "j" in r
                            ...
                            : "W" in r || "U" in r
                            ? ("w" in r || (r.w = "W" in r ? 1 : 0), a.setFullYear(r.y, 0, 1), a.setFullYear(r.y, 0, "W" in r ? ((r.w + 6) % 7) + 7 * r.W - ((a.getDay() + 5) % 7) : r.w + 7 * r.U - ((a.getDay() + 6) % 7)))
        ...
        return {
            ...
            point: function (i, a) {
                var o = i > 0 ? ja : -ja,
                    l = Ma(i - e);
                Ma(l - ja) < Pa
                    ? (n.point(e, (r = (r + a) / 2 > 0 ? Oa : -Oa)), n.point(u, r), n.lineEnd(), n.lineStart(), n.point(o, r), n.point(i, r), (t = 0))
                    : u !== o && l >= ja && (Ma(e - u) < Pa && (e -= u * Pa), Ma(i - o) < Pa && (i -= o * Pa), (r = Ft(e, r, i, a)), n.point(u, r), n.lineEnd(), n.lineStart(), n.point(o, r), (t = 0)),
                    n.point((e = i), (r = a)),
                    (u = o);
            },
            lineEnd: function () {
    ...
    function ve(n, t) {
        ...
        return function (u, i, a, o) {
            var l = a * t;
            null != u ? ((u = de(e, u)), (i = de(e, i)), (a > 0 ? i > u : u > i) && (u += a * Fa)) : ((u = n + a * Fa), (i = n - 0.5 * l));
    ...
    function Lr(n, t) {
        ...
        return (
            ...
            arguments.length ? (e = (t / Fa) * Math.asin(1 / n)) : ((n = 1), (e = t / 4)),
            function (r) {
    ...
    (oa.interpolateZoom = function (n, t) {
        ...
        (oa.behavior.zoom = function () {
            ...
            function g() {
                ...
                y ? clearTimeout(y) : (Il.call(this), (v = e((d = m || oa.mouse(this)))), l(n)),
        ...
        (er.prototype = {
            ...
            remove: function (n) {
                ...
                if (
                    ...
                    i && a ? ((r = e.C), (e.C = n.C), (e.L = i), (i.U = e), e !== a ? ((u = e.U), (e.U = n.U), (n = e.R), (u.L = n), (e.R = a), (a.U = e)) : ((e.U = u), (u = e), (n = e.R))) : ((r = n.C), (n = e)),
                    n && (n.U = u),
                    !r)
                ) {
    ...
    (oa.interpolateTransform = $r),
        ...
        (oa.layout.force = function () {
            ...
            return (
                ...
                (l.alpha = function (n) {
                    return arguments.length
                        ? ((n = +n), u ? (n > 0 ? (u = n) : ((e.c = null), (e.t = NaN), (e = null), c.end({ type: "end", alpha: (u = 0) }))) : n > 0 && (c.start({ type: "start", alpha: (u = n) }), (e = qn(l.tick))), l)
                        : u;
                }),
                (l.start = function () {
                    function n(n, r) {
    ...
    (oa.scale.quantile = function () {
        ...
        (oa.svg.arc = function () {
            function n() {
                ...
                if (h > Pa && (p = Math.min(Math.abs(c - n) / 2, +u.apply(this, arguments))) > 0.001) {
                    v = (c > n) ^ g ? 0 : 1;
                    var T = p,
                        R = p;
                    if (ja > h) {
                    ...
                    if (null != x) {
                        var I = yi(null == S ? [_, w] : [S, k], [y, M], c, T, g),
                            Y = yi([x, b], [_, w], c, T, g);
                        p === T
                            ? A.push("M", I[0], "A", T, ",", T, " 0 0,", v, " ", I[1], "A", c, ",", c, " 0 ", (1 - g) ^ mi(I[1][0], I[1][1], Y[1][0], Y[1][1]), ",", g, " ", Y[1], "A", T, ",", T, " 0 0,", v, " ", Y[0])
                    ...
                    if (null != S) {
                        ...
                        p === R
                            ? A.push("L", V[0], "A", R, ",", R, " 0 0,", v, " ", V[1], "A", n, ",", n, " 0 ", g ^ mi(V[1][0], V[1][1], Z[1][0], Z[1][1]), ",", 1 - g, " ", Z[1], "A", R, ",", R, " 0 0,", v, " ", Z[0])
        ...
        (oa.svg.axis = function () {
            function n(n) {
                n.each(function () {
                    ...
                    if (
                        ("bottom" === r || "top" === r
                            ? ((n = na), (w = "x"), (k = "y"), (S = "x2"), (N = "y2"), C.attr("dy", 0 > q ? "0em" : ".71em").style("text-anchor", "middle"), _.attr("d", "M" + x[0] + "," + q * i + "V0H" + x[1] + "V" + q * i))
                            : ((n = ta), (w = "y"), (k = "x"), (S = "y2"), (N = "x2"), C.attr("dy", ".32em").style("text-anchor", 0 > q ? "end" : "start"), _.attr("d", "M" + q * i + "," + x[0] + "H0V" + x[1] + "H" + q * i)),
                        E.attr(N, q * u),
                        z.attr(k, q * M),
    ...
    oa.svg.brush = function () {
        ...
        return (
            ...
            (n.extent = function (t) {
                var e, r, u, i, l;
                return arguments.length
                    ? (c && ((e = t[0]), (r = t[1]), s && ((e = e[0]), (r = r[0])), (a = [e, r]), c.invert && ((e = c(e)), (r = c(r))), e > r && ((l = e), (e = r), (r = l)), (e != f[0] || r != f[1]) && (f = [e, r])),
                      s && ((u = t[0]), (i = t[1]), c && ((u = u[1]), (i = i[1])), (o = [u, i]), s.invert && ((u = s(u)), (i = s(i))), u > i && ((l = u), (u = i), (i = l)), (u != h[0] || i != h[1]) && (h = [u, i])),
                      n)
